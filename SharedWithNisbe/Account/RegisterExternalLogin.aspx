<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="SharedWithNisbe.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="SharedWithNisbe" %>
